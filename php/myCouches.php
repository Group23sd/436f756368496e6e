                        ...
                        <table class="table table-hover couchTable">
                            ...
                            <?php
                                ...
                                //    echo "<td class='couchTable'><a class='btn btn-xs btn-success couchTable' href='fullCouchDetails.php?id=".$couch['idcouch']."' role='button'><span class='glyphicon glyphicon-plus' alt='Detalles' title='Detalles'></a>";
                                    ...
                                    echo "<a class='btn btn-xs btn-success couchTable' href='couchComments.php?idcouch=".$couch['idcouch']."' role='button'><span class='glyphicon glyphicon-envelope' alt='Comentarios' title='Comentarios'></a>";
                                    echo "<a class='btn btn-xs btn-warning couchTable' href='couchScores.php?idcouch=".$couch['idcouch']."' role='button'><span class='glyphicon glyphicon-star' alt='Puntajes' title='Puntajes'></a>";
